...
const UserSchema = CollectionSchema(
  ...
  links: {
    r'readings': LinkSchema(
      id: -793555634580705268,
      name: r'readings',
      target: r'MeterReading',
      single: false,
      linkName: r'user',
    )
  },
...
void _userAttach(IsarCollection<dynamic> col, Id id, User object) {
  object.id = id;
  object.readings
      .attach(col, col.isar.collection<MeterReading>(), r'readings', id);
}
...
extension UserQueryLinks on QueryBuilder<User, User, QFilterCondition> {
  QueryBuilder<User, User, QAfterFilterCondition> readings(
      FilterQuery<MeterReading> q) {
    return QueryBuilder.apply(this, (query) {
      return query.link(q, r'readings');
    });
  }

  QueryBuilder<User, User, QAfterFilterCondition> readingsLengthEqualTo(
      int length) {
    return QueryBuilder.apply(this, (query) {
      return query.linkLength(r'readings', length, true, length, true);
    });
  }

  QueryBuilder<User, User, QAfterFilterCondition> readingsIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.linkLength(r'readings', 0, true, 0, true);
    });
  }

  QueryBuilder<User, User, QAfterFilterCondition> readingsIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.linkLength(r'readings', 0, false, 999999, true);
    });
  }

  QueryBuilder<User, User, QAfterFilterCondition> readingsLengthLessThan(
    int length, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
      return query.linkLength(r'readings', 0, true, length, include);
    });
  }

  QueryBuilder<User, User, QAfterFilterCondition> readingsLengthGreaterThan(
    int length, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
      return query.linkLength(r'readings', length, include, 999999, true);
    });
  }

  QueryBuilder<User, User, QAfterFilterCondition> readingsLengthBetween(
    int lower,
    int upper, {
    bool includeLower = true,
    bool includeUpper = true,
    ...
    return QueryBuilder.apply(this, (query) {
      return query.linkLength(
          r'readings', lower, includeLower, upper, includeUpper);
    });
  }
}
